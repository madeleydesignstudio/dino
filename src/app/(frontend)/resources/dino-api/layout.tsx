...
const DinoApiLayout = ({ children }: { children: React.ReactNode }) => {
  const { showSidebars } = useSidebarAnimation();
  ...
  return (
    <div className="relative flex min-h-screen">
      ...
      {showSidebars && (
        <div className="fixed left-0 top-[40px] h-[calc(100vh-40px)] w-64 border-r border-neutral-200 bg-neutral-50/80 backdrop-blur-sm">
      ...
      {showSidebars && (
        <div className="fixed right-0 top-[40px] h-[calc(100vh-40px)] w-64 border-l border-neutral-200 bg-neutral-50/80 backdrop-blur-sm">
          <div className="flex h-full flex-col">
            {/* API Status */}
            <div className="border-b border-neutral-200 p-4">
