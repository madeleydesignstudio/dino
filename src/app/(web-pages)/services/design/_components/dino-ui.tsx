...
const DinoUI = () => {
  return (
    <div className="min-h-screen bg-stone-900 dark:bg-stone-50">
      {/* Hero Section */}
      <div className="relative h-[40vh] border-y border-stone-700 overflow-hidden">
        <div className="absolute w-1/3 h-full border-r border-stone-700 bg-stone-800/30 dark:bg-stone-50/30" />
        <div className="absolute w-2/3 h-full border-r border-stone-700 bg-stone-800/20 dark:bg-stone-50/20" />
        <div className="relative z-10 h-full flex items-center justify-center">
          <h1 className="text-8xl font-nanum text-stone-50 dark:text-stone-900 px-8 text-center">
            DINO UI
          </h1>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-6 py-24 space-y-16">
        ...
        <div className="space-y-6">
          ...
          <p className="text-stone-300 dark:text-stone-600 leading-relaxed">
        ...
        <div className="grid grid-cols-2 gap-8">
          <div className="p-6 rounded-lg border border-stone-700 hover:border-stone-600 transition-colors bg-stone-800/50 backdrop-blur-sm dark:bg-stone-100/50">
          ...
          <div className="p-6 rounded-lg border border-stone-700 hover:border-stone-600 transition-colors bg-stone-100/50 backdrop-blur-sm">
            <div className="text-3xl mb-4">🚀</div>
            <h3 className="text-xl font-nanum text-stone-50 dark:text-stone-900 mb-2">
