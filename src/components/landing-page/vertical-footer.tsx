  ...
  return (
    <footer className=" right-0 h-screen w-[33rem] text-stone-900 dark:text-stone-50 overflow-hidden flex flex-col">
      <div className="absolute left-0 top-0 h-full flex items-stretch">
        {/* <div className="w-[0.2px] bg-stone-900 my-6 dark:bg-stone-400" /> */}
      </div>
      <div className="relative z-10 p-8 flex flex-col h-full justify-between">
        ...
        <div className="flex flex-col space-y-8 ">
          ...
          <div className="flex space-x-8 mb-4">
            ...
            <Link href="https://www.linkedin.com/in/danielcmadeley/">
              {" "}
              <svg
                width={20}
                height={20}
            ...
            <Link href="https://www.x.com/danielcmadeley">
              <svg
                width={20}
                height={20}
                viewBox="0 0 24 24"
      ...
      <div className="absolute inset-y-0 right-0 flex items-center overflow-hidden pointer-events-none -z-10">
        <div className="relative left-1/2">
          <span
            className="text-[25rem] font-bold text-stone-900 dark:text-stone-50 leading-none rotate-180"
