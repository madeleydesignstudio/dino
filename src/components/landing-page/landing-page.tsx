    ...
    <section className="hidden md:flex min-w-[768px] w-[125vw] relative">
      ...
      <div className="absolute inset-0">
        <div className="relative h-full w-full ">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-t from-stone-50/10 to-stone-50/30 dark:from-stone-900/60 dark:to-stone-900/30 backdrop-blur-sm" />
        </div>
      </div>
      ...
      <div className="relative h-screen flex-1">
        ...
        <AuroraBackground className="absolute left-0 top-0 h-full w-1/3 backdrop-blur-xl bg-stone-50/80 dark:bg-stone-950/80 border-r border-stone-900 dark:border-stone-400">
          <motion.div
        ...
        <div className="relative z-10 flex h-full w-full flex-col justify-between">
          <main>
            <div className="relative left-0  h-[33.333vh] border-b border-stone-900 dark:border-stone-400 flex items-center justify-center">
      ...
      <div className="w-[30vw] max-w-[568px] min-w-[400px] h-screen border-r border-l border-stone-900 dark:border-stone-400 z-10">
        <a href="/services/design">
          <div className="flex-1 h-1/3 flex flex-col justify-end pb-6 px-6 border-b border-stone-900 dark:border-stone-400 hover:bg-stone-200/50 transition-colors dark:hover:bg-stone-800/50">
